...
$botToken = "7417334652:AAFZiUC2mohOet-fm-E1A4DGP2ozwuCu_9I";
...
$keyboard = json_encode([
    'inline_keyboard' => [
        [
            ['text' => "Owner 🧑‍💻", 'url' => "https://t.me/@Xclpk"],
            ['text' => "BUY 💰", 'url' => "https://t.me/@Xclpk"],
        ],
    ]
]);
...
if ($cdata2 == "back") {
    ...
    $videoUrl = "https://t.me/RNchecker/3";
...
if ($cdata2 == "price") {
    ...
    $priceKeyboard = json_encode([
        'inline_keyboard' => [
            [['text' => '𝑯𝑶𝑴𝑬', 'callback_data' => 'back2'], ['text' => '𝑩𝑼𝒀', 'url' => 'https://t.me/@Xclpk']]
        ]
    ]);
...
𝑬𝒙𝒑𝒍𝒐𝒓𝒆 𝒎𝒆 𝒎𝒐𝒓𝒆 𝒃𝒚 𝒄𝒍𝒊𝒄𝒌𝒊𝒏𝒈 𝒕𝒉𝒆 𝒃𝒖𝒕𝒕𝒐𝒏𝒔 𝒃𝒆𝒍𝒐𝒘</b>");
    ...
    // Change this to your video url
    $backVideoUrl = "https://t.me/RNchecker/3"; 
